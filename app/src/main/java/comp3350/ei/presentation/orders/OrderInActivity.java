...
public class OrderInActivity extends Activity {
    ...
    public void onClickBtnAddOrder(View view) {
        Intent confirm = new Intent(OrderInActivity.this, Messages.class);
        startActivityForResult(confirm, OrderInActivity.CONFIRM_ORDER_REQUEST);
    }

    public void onClickBtnAddItem(View view) {
        Intent addItems = new Intent(OrderInActivity.this, AddItemActivity.class);
        startActivityForResult(addItems, OrderInActivity.ADD_ITEM_REQUEST);
    }

    @Override
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == OrderInActivity.CONFIRM_ORDER_REQUEST && resultCode == RESULT_OK) {
            if(addOrder()){
             Intent viewProduct = new Intent(OrderInActivity.this,
                    ProductActivity.class);
            NavUtils.navigateUpTo(OrderInActivity.this, viewProduct);
            OrderInActivity.this.finish();
            }
        } else if (requestCode == OrderInActivity.ADD_ITEM_REQUEST && resultCode == RESULT_OK && data != null) {
